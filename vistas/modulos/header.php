...
<body class="hold-transition skin-red sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <nav class="navbar navbar-static-top" style="background: #333;">
        <!-- Sidebar toggle button-->
        <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" style="background: #333; border: #1D1C1C;">
        ...
        <ul class="sidebar-menu">
          ...
          if ($_SESSION['almacen'] == 1) {
            echo '<li class="treeview" id="navAlmacen">
              ...
              <ul class="treeview-menu" id="navAlmacen">
                ...
                <li id="navServicio"><a href="servicio.php" id="navServicio"><i class="fa fa-plus-circle"></i> Servicios</a></li>
          ...
          if ($_SESSION['configuracion'] == 1) {
            echo '<li class="treeview" id="navConfiguracion">
              ...
              <ul class="treeview-menu">
                ...
                <li id="navSucursalesLi"><a href="sucursales.php"><i class="fa fa-circle-o"></i> Sucursales</a></li>
          ...
          if ($_SESSION['consultav'] == 1) {
            echo '<li class="treeview" id="navConsultaV">
              ...
              <ul class="treeview-menu">
                <li id="navConsultaServicioVLi"><a href="ventasfechaservicio.php"><i class="fa fa-plus-circle"></i> Consulta Ventas x Servicio</a></li>                
              </ul>
            </li>';
          }
          ?>
