...
function mostrarInicio(){
    ...
    $.post("../controladores/consultas.php?op=totalcomprahoy",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idvendedor : idvendedor, idsucursal : idsucursal}, function(data,status)
	{
    ...
    $.post("../controladores/consultas.php?op=totalventahoy",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idvendedor : idvendedor, idsucursal : idsucursal}, function(data,status)
	{
    ...
    $.post("../controladores/consultas.php?op=totalventachoy",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idvendedor : idvendedor, idsucursal : idsucursal}, function(data,status)
	{
    ...
    $.post("../controladores/consultas.php?op=totalcuentasporcobrar",{fecha_inicio : fecha_inicio, fecha_fin : fecha_fin, idvendedor : idvendedor, idsucursal : idsucursal}, function(data,status)
	{
