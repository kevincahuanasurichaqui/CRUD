...
function listar()
{
	...
	console.log(fecha_inicio,fecha_fin,estado,idsucursal2);
...
function agregarDetalle(idproducto,producto,cant,desc,precio_venta,precioB,precioC,precioD,stock,proigv,unidadmedida){
	...
	if (idproducto!="") {
        ...
        '<td><input style="text-align:center; width: 80px;" type="number" step="0.01" oninput="modificarSubtotales()" name="cantidad[]" id="cantidad[]" value="'+cantidad+'"></td>'+
