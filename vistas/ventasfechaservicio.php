...
?>
            ...
            <div class="panel panel-default" style="border-color: #666; border-width: 3px; border-style: double;">
              <div class="panel-heading">
                <div class="box-header with-border">
                  <h1 class="box-title">Consulta de Ventas por Fecha, Servicio y Vendedor</h1>
              ...
              <div class="panel-body table-responsive" id="listadoregistros">
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-bottom: 25px;">
  ...
  ?>
  <script type="text/javascript" src="js/ventasfechaservicio.js"></script>
