									...
									<section class="content table-responsive">
										...
										<table id="tablaCaja" class="table table-striped table-sm table-hover table-lg table-responsive table-bordered" style="width: 100%;">
											...
											<tbody id="tblCompraS">
												...
												<tr>
													<td><img src="https://protechperu.com/facturacion/img/factura.svg" style="width: 25px;margin-left: 30px;"> Facturas
												...
												<tr>
													<td><img src="https://protechperu.com/facturacion/img/boleta.svg" style="width: 25px;margin-left: 30px;"> Boletas
												...
												<tr>
													<td><img src="https://protechperu.com/facturacion/public/img/svg/nota_venta2.svg" style="width: 25px;margin-left: 30px;"> Notas de Venta
