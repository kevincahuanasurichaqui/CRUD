...
Class Compra
{
	...
	public function insertar($idsucursal,$idproveedor,$idpersonal,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$impuesto,$total_compra,$idproducto,$cantidad,$precio_compra,$precio_venta)
	{
		$sql="INSERT INTO compra (idsucursal,idproveedor,idpersonal,tipo_comprobante,serie_comprobante,num_comprobante,fecha_hora,impuesto,total_compra,estado)
		VALUES ('$idsucursal','$idproveedor','$idpersonal','$tipo_comprobante','$serie_comprobante','$num_comprobante','$fecha_hora','$impuesto','$total_compra','Aceptado')";
		...
		{
			$sql_detalle = "INSERT INTO detalle_compra(idsucursal,idcompra,idproducto,cantidad,precio_compra,precio_venta) VALUES ('$idsucursal','$idingresonew', '$idproducto[$num_elementos]','$cantidad[$num_elementos]','$precio_compra[$num_elementos]','$precio_venta[$num_elementos]')";
