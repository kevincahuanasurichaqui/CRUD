...
public function insertar($idsucursal,$idcliente,$idpersonal,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$total_venta,$titulo,$saludo,$nota,$idproducto,$cantidad,$precio_venta,$descuento){

	$sql="INSERT INTO cotizacion (idsucursal,idcliente,idpersonal,tipo_comprobante,serie_comprobante,num_comprobante,fecha_hora,total_venta,titulo,saludo,nota) VALUES 
	('$idsucursal','$idcliente','$idpersonal','$tipo_comprobante','$serie_comprobante','$num_comprobante','$fecha_hora','$total_venta','$titulo','$saludo','$nota')";
